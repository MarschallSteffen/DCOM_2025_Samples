...
public abstract class AbstractBookInventoryValidation implements InventoryValidation {

    protected final StoreInventoryService storeInventoryService;

    AbstractBookInventoryValidation(StoreInventoryService storeInventoryService){
